 ...
 * @defgroup	CAPI_MAP_VIEW_MODULE Map View
 *
 * @brief	The Map View API provides a map view with basic interactive
 ...
 *
 * The Map View API provides a developer with a set of functions, bringing basic
 * interactive visual user interface in maps applications\n
 * Map View API comprises following features:
 *  - Map view widget
 *  - Zoom and rotation

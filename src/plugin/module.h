...
typedef int (*maps_plugin_is_widget_supported_f) (maps_service_widget_e data, bool *supported);
...
typedef struct _interface_s {
	...
	maps_plugin_is_widget_supported_f maps_plugin_is_widget_supported;

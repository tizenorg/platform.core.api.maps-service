...
/* Mapping */
int maps_plugin_create_map_view_empty(const maps_view_h view, maps_plugin_map_view_ready_cb callback)
{
	return 0;
}

int maps_plugin_destroy_map_view_empty(const maps_view_h view, maps_plugin_map_view_ready_cb callback)
{
	return 0;
}

int maps_plugin_render_map_empty(const maps_view_h view, const maps_coordinates_h coordinates, const double zoom_factor,
				 const double rotation_angle, maps_plugin_render_map_cb callback, void* user_data,
				 int* request_id)
{
	return 0;
}

int maps_plugin_move_center_empty(const maps_view_h view, const int delta_x, const int delta_y,
				  maps_plugin_render_map_cb callback, void* user_data, int* request_id)
{
	return 0;
}

int maps_plugin_set_scalebar_empty(const maps_view_h view, bool enable)
{
	return 0;
}

int maps_plugin_get_scalebar_empty(const maps_view_h view, bool *enabled)
{
	return 0;
}

int maps_plugin_draw_map_empty(const maps_view_h view, Evas* canvas, const int x, const int y, const int width, const int height)
{
	return 0;
}

int maps_plugin_on_object_empty(const maps_view_h view, const maps_view_object_h object, const maps_view_object_operation_e operation)
{
	return 0;
}

int maps_plugin_screen_to_geography_empty(const maps_view_h view, const int x, const int y, maps_coordinates_h *coordinates)
{
	return 0;
}

int maps_plugin_geography_to_screen_empty(const maps_view_h view, const maps_coordinates_h coordinates, int* x, int* y)
{
	return 0;
}

int maps_plugin_get_min_zoom_level_empty(const maps_view_h view, int *min_zoom_level)
{
	return 0;
}

int maps_plugin_get_max_zoom_level_empty(const maps_view_h view, int *max_zoom_level)
{
	return 0;
}

int maps_plugin_get_center_empty(const maps_view_h view, maps_coordinates_h *coordinates)
{
	return 0;
}

...
EXPORT_API int maps_address_list_length(maps_address_list_h address_list, int *length)
{
	...
	*length = g_list_length((GList *)address_list);
...
EXPORT_API int maps_address_list_foreach(maps_address_list_h address_list, maps_address_list_cb callback, void *user_data)
{
...
EXPORT_API int maps_address_list_destroy(maps_address_list_h address_list, maps_address_h address)
{
	...
	g_list_free_full((GList *)address_list, _free_address);
	address_list = NULL;

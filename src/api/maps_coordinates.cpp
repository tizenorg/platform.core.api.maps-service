...
EXPORT_API int maps_coordinates_get(const maps_coordinates_h coords,
					      double *latitude,
					      double *longitude)
{
...
EXPORT_API int maps_coordinates_set(maps_coordinates_h coords,
	const double latitude,
	const double longitude)
{
	if (!coords)
...
EXPORT_API int maps_coordinates_list_foreach(maps_coordinates_list_h coordinates_list, maps_coordinates_list_cb callback, void *user_data)
{
	...
	GList *l = (GList *)coordinates_list;
	l = g_list_first(l);
	while (l != NULL)
	{
		GList *next = l->next;
...
EXPORT_API int maps_coordinates_list_destroy(maps_coordinates_list_h coordinates_list)
{
	...
	g_list_free_full((GList *)coordinates_list, _free_coordinates);

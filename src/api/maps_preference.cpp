...
EXPORT_API int maps_preference_get_route_alternatives(const maps_preference_h preference, bool *enable)
{
	if (!preference)
		return MAPS_ERROR_INVALID_PARAMETER;
...
EXPORT_API int maps_preference_set_route_alternatives(maps_preference_h preference, bool enable)
{
	if (!preference)
		return MAPS_ERROR_INVALID_PARAMETER;

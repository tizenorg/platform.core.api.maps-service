...
int _map_event_data_set_scale_factor(map_event_data_h event,
					  ...
					  map_event_data_h *cloned)
{
	...
	do {
		...
		_map_event_data_set_scale_factor(*cloned, e->zoom_factor);
				    ...
				    map_event_data_h *cloned)
{
	...
	do {
		...
		error = _map_event_data_set_scale_factor(*cloned,
							e->zoom_factor);
...
EXPORT_API int map_event_data_get_scale_factor(map_event_data_h event,
						   double *zoom_factor)
{
	MAPS_LOG_API;

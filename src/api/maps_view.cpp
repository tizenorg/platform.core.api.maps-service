...
EXPORT_API int maps_view_set_map_type(maps_view_h view, maps_view_type_e type)
{
	if (!view)
		return MAPS_ERROR_INVALID_PARAMETER;
...
EXPORT_API int maps_view_get_map_type(const maps_view_h view, maps_view_type_e *type)
{
	if (!view || !type)
		return MAPS_ERROR_INVALID_PARAMETER;
	maps_view_s *v = (maps_view_s *) view;

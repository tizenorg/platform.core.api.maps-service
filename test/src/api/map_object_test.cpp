...
void utc_map_object_poly_set_points_p(void)
{
	...
	maps_coord_list_h list = NULL;
	error = maps_coord_list_create(&list);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
	g_assert(list);

	error = maps_coord_list_append(list, c1);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);

	error = maps_coord_list_append(list, c2);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
	...
	error = maps_coord_list_destroy(list);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
...
void utc_map_object_poly_set_points_n(void)
{
	...
	maps_coord_list_h list = NULL;
	int error = maps_coord_list_create(&list);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
	g_assert(list);

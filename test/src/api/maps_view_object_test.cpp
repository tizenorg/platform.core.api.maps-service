...
void utc_maps_view_object_create_n(void)
{
	...
	maps_view_object_h object = NULL;
	int error = _maps_view_object_create((maps_view_object_type_e)-2,
					   &object);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
	g_assert(!object);

	error = _maps_view_object_create(MAPS_VIEW_OBJECT_MARKER, NULL);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
	g_assert(!object);
}
...
class test_env
{
 public:
	...
	int iterations;
 public:
	test_env(const maps_view_object_type_e type) : o(NULL), iterations(0)
	{
		/* Create a test view object */
		int error = _maps_view_object_create(type, &o);
		g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
		g_assert(o);
	}
	~test_env()
...
{
	test_env e(MAPS_VIEW_OBJECT_MARKER);

	maps_view_object_type_e type = MAPS_VIEW_OBJECT_UNKNOWN;
	const int error = maps_view_object_get_type(e.o, &type);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
	g_assert_cmpint(type, ==, MAPS_VIEW_OBJECT_MARKER);
}
...
void utc_maps_view_object_get_type_n(void)
{
	...
	maps_view_object_type_e type = MAPS_VIEW_OBJECT_UNKNOWN;
	int error = maps_view_object_get_type(NULL, &type);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
	g_assert_cmpint(type, ==, MAPS_VIEW_OBJECT_UNKNOWN);

	error = maps_view_object_get_type(e.o, NULL);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
	g_assert_cmpint(type, ==, MAPS_VIEW_OBJECT_UNKNOWN);
}
...
void utc_maps_view_object_move_p(void)
{
	...
	error = maps_view_object_move(e.o, coords);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
	...
	error = maps_view_object_get_shape_data(e.o, &marker_data);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
...
void utc_maps_view_object_move_n(void)
{
	...
	error = maps_view_object_move(NULL, coords);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);

	error = maps_view_object_move(e.o, NULL);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
...
void utc_maps_view_object_set_visible_p(void)
{
	...
	int error = maps_view_object_set_visible(e.o, true);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);

	bool visible = false;
	error = maps_view_object_get_visible(e.o, &visible);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
	g_assert(visible);

	error = maps_view_object_set_visible(e.o, false);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
...
void utc_maps_view_object_set_visible_n(void)
{
	...
	int error = maps_view_object_set_visible(NULL, true);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
}
...
void utc_maps_view_object_get_visible_p(void)
{
	...
	bool visible = true;
	int error = maps_view_object_get_visible(e.o, &visible);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
	g_assert(!visible);
}
...
{
	bool visible = true;
	int error = maps_view_object_get_visible(NULL, &visible);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
	g_assert(visible);
}
...
void utc_maps_view_object_hit_test_p(void)
{
	...
	bool is_hit = false;
	error = maps_view_object_hit_test(e.o, coords, &is_hit);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
	...
	is_hit = true;
	error = maps_view_object_hit_test(e.o,
					      37.4 - 1.1, 127.2 - 1.1,
					      &is_hit);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
	g_assert(!is_hit);*/
...
void utc_maps_view_object_hit_test_n(void)
{
	...
	bool is_hit = true;
	error = maps_view_object_hit_test(NULL, coords, &is_hit);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
	g_assert(is_hit);

	error = maps_view_object_hit_test(e.o, NULL, &is_hit);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
	g_assert(is_hit);

	error = maps_view_object_hit_test(e.o, coords, NULL);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
	g_assert(is_hit);
...
/*int maps_view_object_polyline_add_point(maps_view_object_h poly,
					const maps_coordinates_h point);*/
void utc_maps_view_object_poly_add_point_p(void)
{
	test_env e(MAPS_VIEW_OBJECT_POLYLINE);
	...
	error = maps_view_object_polyline_add_point(e.o, c);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
...
void utc_maps_view_object_poly_add_point_n(void)
{
	...
	error = maps_view_object_polyline_add_point(NULL, c);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);

	error = maps_view_object_polyline_add_point(e.o, NULL);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
...
/*int maps_view_object_polyline_set_polyline(maps_view_object_h poly,
...
void utc_maps_view_object_poly_set_points_p(void)
{
	...
	/* Test */
	error = maps_view_object_polyline_set_polyline(e.o, list);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
...
void utc_maps_view_object_poly_set_points_n(void)
{
	...
	/* Test */
	error = maps_view_object_polyline_set_polyline(NULL, list);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);

	error = maps_view_object_polyline_set_polyline(e.o, NULL);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
...
/*int maps_view_object_polyline_foreach_point(maps_view_object_h poly,
...
typedef bool(*maps_view_object_poly_point_cb) (int index, int total,
					      ...
					      void *user_data);*/
static bool __utc_maps_view_object_poly_point_cb(int index, int total,
					       maps_coordinates_h point,
					       void *user_data)
{
...
void utc_maps_view_object_poly_foreach_point_p(void)
{
	...
	/* Test */
	error = maps_view_object_polyline_foreach_point(e.o,
				       __utc_maps_view_object_poly_point_cb,
				       &e);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
...
void utc_maps_view_object_poly_foreach_point_n(void)
{
	...
	int error = maps_view_object_polyline_foreach_point(NULL,
				       __utc_maps_view_object_poly_point_cb,
				       &e);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
	g_assert_cmpint(e.iterations, ==, 0);

	error = maps_view_object_polyline_foreach_point(e.o, NULL, &e);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
	g_assert_cmpint(e.iterations, ==, 0);
}
...
{
	test_env e(MAPS_VIEW_OBJECT_POLYLINE);
	int error = maps_view_object_polyline_set_color(e.o,
						       0x11, 0x22, 0x33, 0x44);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
}
...
{
	test_env e(MAPS_VIEW_OBJECT_POLYLINE);
	int error = maps_view_object_polyline_set_color(NULL,
						       0x11, 0x22, 0x33, 0x44);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
}
...
void utc_maps_view_object_polyline_get_color_p(void)
{
	...
	error = maps_view_object_polyline_get_color(e.o, &r, &g, &b, &a);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
...
void utc_maps_view_object_polyline_get_color_n(void)
{
	test_env e(MAPS_VIEW_OBJECT_POLYLINE);
	unsigned char r, g, b, a;
	int error = maps_view_object_polyline_get_color(NULL, &r, &g, &b, &a);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
}
...
{
	test_env e(MAPS_VIEW_OBJECT_POLYLINE);
	int error = maps_view_object_polyline_set_width(e.o, 3);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
}
...
void utc_maps_view_object_polyline_set_width_n(void)
{
	...
	int error = maps_view_object_polyline_set_width(NULL, 3);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);

	error = maps_view_object_polyline_set_width(e.o, -3);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
}
...
void utc_maps_view_object_polyline_get_width_p(void)
{
	...
	int width = 0;
	error = maps_view_object_polyline_get_width(e.o, &width);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
...
void utc_maps_view_object_polyline_get_width_n(void)
{
	...
	int width = 0;
	int error = maps_view_object_polyline_get_width(NULL, &width);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);

	error = maps_view_object_polyline_get_width(e.o, NULL);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
}
...
{
	test_env e(MAPS_VIEW_OBJECT_POLYGON);
	int error = maps_view_object_polygon_set_fill_color(e.o,
							   0x11,
							   0x22,
							   0x33,
							   0x44);
...
{
	test_env e(MAPS_VIEW_OBJECT_POLYGON);
	int error = maps_view_object_polygon_set_fill_color(NULL,
							   0x11,
							   0x22,
							   0x33,
							   0x44);
...
void utc_maps_view_object_polygon_get_fill_color_p(void)
{
	...
	unsigned char r, g, b, a;
	error = maps_view_object_polygon_get_fill_color(e.o,
						       &r, &g, &b, &a);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
	g_assert_cmpint(r, ==, 0x11);
	g_assert_cmpint(g, ==, 0x22);
...
void utc_maps_view_object_polygon_get_fill_color_n(void)
{
	test_env e(MAPS_VIEW_OBJECT_POLYGON);
	unsigned char r, g, b, a;
	int error = maps_view_object_polygon_get_fill_color(NULL,
						       &r, &g, &b, &a);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
}
...
void utc_maps_view_object_marker_set_coordinates_p(void)
{
	...
	error = maps_view_object_marker_set_coordinates(e.o, c);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
...
void utc_maps_view_object_marker_set_coordinates_n(void)
{
	...
	error = maps_view_object_marker_set_coordinates(NULL, c);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);

	error = maps_view_object_marker_set_coordinates(e.o, NULL);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
...
void utc_maps_view_object_marker_set_screen_size_p(void)
{
	...
	int error = maps_view_object_marker_resize(e.o, 13, 42);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
}
...
void utc_maps_view_object_marker_set_screen_size_n(void)
{
	...
	int error = maps_view_object_marker_resize(NULL, 13, 42);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);

	error = maps_view_object_marker_resize(e.o, -13, 42);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
...
/*int maps_view_object_marker_set_imate_file(maps_view_object_h marker,
...
void utc_maps_view_object_marker_set_file_path_p(void)
{
	...
	int error = maps_view_object_marker_set_image_file(e.o, "marker.png");
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
#endif
}
...
void utc_maps_view_object_marker_set_file_path_n(void)
{
	...
	int error = maps_view_object_marker_set_image_file(NULL, "marker.png");
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);

	error = maps_view_object_marker_set_image_file(e.o, NULL);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
#endif
}
...
void utc_maps_view_object_marker_set_type_p(void)
{
	...
	int error = maps_view_object_marker_set_type(e.o, MAP_MARKER_PIN);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
#endif
}
...
void utc_maps_view_object_marker_set_type_n(void)
{
	...
	int error = maps_view_object_marker_set_type(NULL, MAP_MARKER_PIN);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);

	error = maps_view_object_marker_set_type(e.o,
			maps_view_marker_type_e(MAP_MARKER_PIN - 100));
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
#endif
}
...
void utc_maps_view_object_marker_set_text_p(void)
{
	...
	int error = maps_view_object_marker_set_text(e.o, "Demo Marker");
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
}
...
void utc_maps_view_object_marker_set_text_n(void)
{
	...
	int error = maps_view_object_marker_set_text(NULL, "Demo Marker");
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);

	error = maps_view_object_marker_set_text(e.o, NULL);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
}
...
void utc_maps_view_object_marker_get_coordinates_p(void)
{
	...
	error = maps_view_object_marker_get_coordinates(e.o, &c);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
...
void utc_maps_view_object_marker_get_coordinates_n(void)
{
	...
	int error = maps_view_object_marker_get_coordinates(NULL, &c);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);

	error = maps_view_object_marker_get_coordinates(e.o, NULL);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
}


/*int maps_view_object_marker_get_size(maps_view_object_h marker,
					  int *screen_width,
					  int *screen_height);*/
void utc_maps_view_object_marker_get_screen_size_p(void)
{
	...
	error = maps_view_object_marker_get_size(e.o, &width, &height);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
...
void utc_maps_view_object_marker_get_screen_size_n(void)
{
	...
	int width = 0, height = 0;
	int error = maps_view_object_marker_get_size(NULL, &width, &height);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
}
...
void utc_maps_view_object_marker_get_image_file_p(void)
{
	...
	char *file_path = NULL;
	error = maps_view_object_marker_get_image_file(e.o, &file_path);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
	g_assert(file_path);
...
void utc_maps_view_object_marker_get_image_file_n(void)
{
	...
	char *file_path = NULL;
	int error = maps_view_object_marker_get_image_file(NULL, &file_path);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);

	error = maps_view_object_marker_get_image_file(e.o, NULL);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
}
...
void utc_maps_view_object_marker_get_type_p(void)
{
	...
	maps_view_marker_type_e type = MAP_MARKER_NONE;
	int error = maps_view_object_marker_get_type(e.o, &type);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
}
...
void utc_maps_view_object_marker_get_type_n(void)
{
	...
	maps_view_marker_type_e type = MAP_MARKER_NONE;
	int error = maps_view_object_marker_get_type(NULL, &type);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);

	error = maps_view_object_marker_get_type(e.o, NULL);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
}
...
void utc_maps_view_object_marker_get_text_p(void)
{
	...
	char *text = NULL;
	error = maps_view_object_marker_get_text(e.o, &text);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
	g_assert(text);
...
void utc_maps_view_object_marker_get_text_n(void)
{
	...
	char *text = NULL;
	int error = maps_view_object_marker_get_text(NULL, &text);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);

	error = maps_view_object_marker_get_text(e.o, NULL);
	g_assert_cmpint(error, ==, MAPS_ERROR_INVALID_PARAMETER);
}

...
/*int map_view_geolocation_to_screen(const maps_view_h view,
				  const maps_coordinates_h coordinates,
				  int *x, int *y);*/
...
/*typedef void(*map_view_on_gesture_cb) (maps_error_e result,
				     ...
				     void *user_data);
int map_view_set_on_gesture_callback(maps_view_h view,
...
/*typedef void(*map_view_on_zoom_cb) (maps_error_e result,
				     ...
				     const double factor,
				     void *user_data);
int map_view_set_on_zoom_callback(maps_view_h view,
...
/*typedef void(*map_view_on_rotate_cb) (maps_error_e result,
				       ...
				       const double angle,
				       void *user_data);
int map_view_set_on_rotate_callback(maps_view_h view,
...
/*typedef void(*map_view_on_object_cb) (maps_error_e result,
				       ...
				       void *user_data);
int map_view_set_on_object_callback(maps_view_h view,
...
int map_view_set_on_ready_callback(maps_view_h view,
...
/*int map_view_set_gesture_action(maps_view_h view,
...
/*int map_view_disable_gesture(maps_view_h view,
			      const map_view_gesture_e gesture);*/
void utc_map_view_disable_gesture_p(void);
void utc_map_view_disable_gesture_n(void);


/*int map_view_add_marker_type(maps_view_h view,
			      const maps_coordinates_h coordinates,
...
/*int map_view_add_marker_image(maps_view_h view,
			       const maps_coordinates_h coordinates,
...
/*int map_view_add_route(maps_view_h view,
...
/*int map_view_add_image(maps_view_h view,
			const char *image_file_name,
...
/*int map_view_add_polyline(maps_view_h view,
			   const maps_item_list_h coordinates,
...
/*int map_view_add_polygon(maps_view_h view,
			  const maps_item_list_h coordinates,
			  const unsigned char r,
			  const unsigned char g,
			  const unsigned char b,
...
/*int map_view_add_circle(maps_view_h view,
			 const maps_coordinates_h coordinates,
			 const double radius,
			 const unsigned char r,
			 const unsigned char g,
...
/*int map_view_add_text(maps_view_h view,
		       const maps_coordinates_h coordinates,
		       const char *str,
		       const unsigned char r,
		       const unsigned char g,
...
/*typedef bool(*map_object_cb) (int index, int total,
				     ...
				     void *user_data);
int map_view_foreach_object(const maps_view_h view,

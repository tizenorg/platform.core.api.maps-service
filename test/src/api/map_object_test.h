...
/*int map_object_marker_set_screen_size(map_object_h marker,
					  const int screen_width,
					  const int screen_height);*/
void utc_map_object_marker_set_screen_size_p(void);
void utc_map_object_marker_set_screen_size_n(void);

/*int map_object_marker_set_file_path(map_object_h marker,
...
/*int map_object_marker_get_screen_size(map_object_h marker,
					  int *screen_width,
					  int *screen_height);*/

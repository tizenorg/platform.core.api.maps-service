...
void utc_construct_route_p(void)
{
	...
	map_view_object_h route_object = rc.construct(NULL,
						      r.route);
	...
	int error = map_view_object_route_get_content(route_object,
						      &route_handle);
	...
	error = _map_view_object_destroy(route_object);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
}
...
{
	view::route_constructor rc;
	map_view_object_h route_object = rc.construct(NULL, NULL);
...
void utc_construct_route_p(void)
{
	...
	/* Construct route view object */
	view::route_constructor rc;
	map_view_object_h route_object = rc.construct(r.route);
	g_assert_cmpint(rc.get_error(), ==, MAPS_ERROR_NONE);
	g_assert(route_object);

	/* Check if the route object includes route handle */
	maps_route_h route_handle = NULL;
	int error = map_view_object_layer_get_route(route_object,
						     &route_handle);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
	g_assert(route_handle);
	...
	int iterations = 0;
	error = map_view_object_layer_foreach_object(route_object,
...
public:
	static int utc_add_marker(map_view_object_h route_object,
				  const maps_coordinates_h coords,
				  map_view_marker_type_e type);
	void utc_add_start_marker(map_view_object_h route_object,
				  maps_route_h route);
	void utc_add_finish_marker(map_view_object_h route_object,
				   maps_route_h route);

	static int utc_add_trajectory(map_view_object_h route_object,
	...
	void utc_add_route_path(map_view_object_h route_object,
				maps_route_h route);
	static bool utc_collect_path_points(int index, int total,
					    maps_coordinates_h coordinates,
					    void *user_data);

	void utc_add_route_segments(map_view_object_h route_object,
				    maps_route_h route);
...
int utc_route_constructor::utc_add_marker(map_view_object_h route_object,
					  const maps_coordinates_h coords,
					  map_view_marker_type_e type)
{
...
void utc_route_constructor::utc_add_start_marker(map_view_object_h route_object,
						 maps_route_h route)
{
	add_start_marker(route_object, route);
}

void utc_route_constructor::utc_add_finish_marker(map_view_object_h
						  route_object,
						  maps_route_h route)
{
...
int utc_route_constructor::utc_add_trajectory(map_view_object_h route_object,
					      maps_item_list_h route_points)
{
...
void utc_route_constructor::utc_add_route_path(map_view_object_h route_object,
					       maps_route_h route)
{
...
void utc_route_constructor::utc_add_route_segments(map_view_object_h
						   route_object,
						   maps_route_h route)
{
...
/*----------------------------------------------------------------------------*/
/*static int add_marker(map_view_object_h route_object,
				       const maps_coordinates_h coords,
				       map_view_marker_type_e type);*/
...
/*void add_start_marker(map_view_object_h route_object,
		      maps_route_h route);*/
void utc_add_start_marker_p(void)
{
	...
	int error = map_view_object_layer_foreach_object(e.o,
				   __utc_map_view_object_layer_object_cb,
				   &e.iterations);
	g_assert_cmpint(error, ==, MAPS_ERROR_NONE);
	g_assert_cmpint(e.iterations, ==, 1);
...
/*void add_finish_marker(map_view_object_h route_object,
		       maps_route_h route);*/
...
/*static int add_trajectory(map_view_object_h route_object,
			  maps_item_list_h route_points);*/
...
/*void add_route_path(map_view_object_h route_object,
		    maps_route_h route);*/
...
/*void add_route_segments(map_view_object_h route_object,
			maps_route_h route);*/

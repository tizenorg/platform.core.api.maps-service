...
static void __add_map_event_data_tests(int i)
{
	...
	if (1) {
		...
		__test_add_func_load("/api/map_event_data/get_tilt_p",
				     utc_map_event_data_get_tilt_p, i);
		__test_add_func_load("/api/map_event_data/get_tilt_n",
				     utc_map_event_data_get_tilt_n, i);

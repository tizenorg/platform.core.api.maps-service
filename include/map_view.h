...
#if 0 /* We will add this enum if plugins support them */
 ...
 *
 */
typedef enum _map_view_event_e {

	MAP_VIEW_EVENT_SCROLL = 1, /** Indicates the pan user gesture */		
	MAP_VIEW_EVENT_DOUBLE_TAP_ZOOM, /** < Indicates the one-finger/two-finger tap  to zoom, 
	                                                                  one-finger is zoom-in, two-finter is zoom-out */
	MAP_VIEW_EVENT_PINCH_ZOOM, /**Indicates the pinch to zoom */
	MAP_VIEW_EVENT_ROTATE,	/** Indicates the rotate user gesture */
	MAP_VIEW_EVENT_TILT,	/** Indicates the rotate user gesture */

	/* TODO: Investigate how separate GESTURE events and CONTROL events 
     	MAP_VIEW_EVENT_CONTROL_TAP = 101,
	*/
	 
	MAP_VIEW_EVENT_TAP, /**< Indicates the tap user gesture */
	MAP_VIEW_EVENT_FLICK, /**< Indicates the tap user gesture */
	MAP_VIEW_EVENT_DOUBLE_TAP, /**< Indicates the double tap user gesture */
	MAP_VIEW_EVENT_TWO_FINGER_TAP, /**< Indicates the two-finger tap user  gesture */
	MAP_VIEW_EVENT_LONG_PRESS, /**< Indicates the long press user gesture */
	MAP_VIEW_EVENT_NONE = 0,	/** Indicates the empty gesture */
} map_view_event_e;


/* TODO: should decide we provide ready callback different from event callback */
/**
 * @brief	Called when the map is ready to be used.
 * @details The map view invokes this callback when the map is ready to be used.
 * @since_tizen 3.0
 * 
 * @param[in]	result		the result of function
 * @param[in]	map_view 	The map instance which can be controlled by user
 * @param[in]	user_data	The user data pointer registered in maps_view_create.
 *
 */
typedef void(*map_view_on_map_ready_cb) (maps_error_e result, map_view_h map_view, void *user_data);
 ...
 * @param[in]	event_data	The event information
 ...
 */
/* TODO: which one? 
typedef void(*map_view_on_event_cb) (map_view_event_e event, void *event_info, void *user_data);
*/
typedef void(*map_view_on_event_cb) (maps_error_e result,
                                     const map_event_type_e event,
 ...
 * map_view_set_type(), map_view_set_screen_location() and map_view_set_visibility()
 * respectively.
 * @since_tizen 3.0
 * @privlevel public
 ...
 * @see map_view_create()
 */
int map_view_set_buildings_enabled(map_view_h view, const bool enabled);
 ...
 * @see map_view_create()
 */
int map_view_get_buildings_enabled(map_view_h view, bool *enabled);
 ...
 * @see map_view_create()
 */
int map_view_set_traffic_enabled(map_view_h view, const bool enabled);
 ...
 * @see map_view_create()
 */
int map_view_get_traffic_enabled(map_view_h view, bool *enabled);
 ...
 * @see map_view_create()
 */
int map_view_set_public_transit_enabled(map_view_h view, const bool enabled);
 ...
 * @see map_view_create()
 */
int map_view_get_public_transit_enabled(map_view_h view, bool *enabled);
 ...
 * @see map_view_create()
 */
int map_view_set_event_cb(map_view_h view, 
				  map_view_event_e event,
 ...
 * @see map_view_create()
 */
int map_view_unset_event_cb(map_view_h view, map_gesture_e gesture);

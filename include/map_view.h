...
/**
 * @brief	Enumerations of map view types (themes)
 * @since_tizen 3.0
 */
...
typedef enum _map_action_e {
	...
	MAP_ACTION_MOVE, /**< Indicates the move center action */
 ...
 * | :------------------------------ | :--------------------------------- |
 * | #MAP_GESTURE_PAN                | #MAP_ACTION_MOVE                   |
 * | #MAP_GESTURE_FLICK              | #MAP_ACTION_MOVE                   |
 * | #MAP_GESTURE_PINCH              | #MAP_ACTION_ZOOM                   |
 * | #MAP_GESTURE_TAP                | #MAP_ACTION_MOVE, #MAP_ACTION_ZOOM |
 * | #MAP_GESTURE_DOUBLE_TAP         | #MAP_ACTION_ZOOM, #MAP_ACTION_MOVE |
 ...
 * | #MAP_GESTURE_PRESS              | #MAP_ACTION_MOVE, #MAP_ACTION_ZOOM |

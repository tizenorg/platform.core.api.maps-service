...
typedef enum _map_type_e {
	MAP_TYPE_NONE,      /** Indicates no base map */
 ...
 * @since_tizen 3.0
 * @remarks @a object must be released using map_object_destroy().
 *
 * @param[in]	index		The current index of the visual object
 ...
 */
typedef void(*map_view_on_event_cb) (maps_error_e result, const map_event_type_e type,
 ...
 *
 */
int map_view_destroy(const map_view_h view);
 ...
 * @see map_view_create()
 */
int map_view_set_center(const map_view_h view, const maps_coordinates_h coordinates);
 ...
 * @see map_view_create()
 */
int map_view_set_zoom_level(const map_view_h view, const int level);
 ...
 * @see map_view_create()
 */
int map_view_set_map_type(const map_view_h view, const map_type_e type);
 ...
 */
int map_view_set_buildings_enabled(const map_view_h view, const bool enable);
 ...
 * @see map_view_create()
 */
int map_view_set_traffic_enabled(const map_view_h view, const bool enable);
 ...
 * @see map_view_create()
 */
int map_view_set_public_transit_enabled(const map_view_h view, const bool enable);
 ...
 * @see map_view_create()
 */
int map_view_set_language(const map_view_h view, const char *language);
 ...
 * @see map_view_create()
 */
int map_view_set_event_cb(const map_view_h view, const map_event_type_e type,
 ...
 * @see map_view_create()
 */
int map_view_unset_event_cb(const map_view_h view, const map_event_type_e type);
 ...
 * @see map_view_create()
 */
int map_view_set_gesture_enabled(const map_view_h view, const map_gesture_e gesture, const bool enabled);
 ...
 * @see map_view_create()
 */
int map_view_get_gesture_enabled(const map_view_h view, const map_gesture_e gesture, bool *enabled);
 ...
 * @see map_view_create()
 */
int map_view_set_scalebar_enabled(const map_view_h view, const bool enable);
 ...
 * @see map_view_create()
 */
int map_view_add_object(const map_view_h view, const map_object_h object);
 ...
 * @see map_view_create()
 */
int map_view_remove_object(const map_view_h view, const map_object_h object);
 ...
 * @see map_view_create()
 */
int map_view_remove_all_objects(const map_view_h view);

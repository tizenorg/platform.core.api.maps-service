 ...
 * @see map_view_create()
 */
int map_view_set_zoom_level(const map_view_h view, int level);
 ...
 * @see map_view_create()
 */
int map_view_set_orientation(const map_view_h view, double angle);
 ...
 * @see map_view_create()
 */
int map_view_set_map_type(const map_view_h view, map_type_e type);
 ...
 */
int map_view_set_buildings_enabled(const map_view_h view, bool enable);
 ...
 * @see map_view_create()
 */
int map_view_set_traffic_enabled(const map_view_h view, bool enable);
 ...
 * @see map_view_create()
 */
int map_view_set_public_transit_enabled(const map_view_h view, bool enable);
 ...
 * @see map_view_create()
 */
int map_view_set_screen_location(const map_view_h view, int x, int y, int width, int height);
 ...
 * @see map_view_create()
 */
int map_view_move(const map_view_h view, int x, int y);
 ...
 * @see map_view_create()
 */
int map_view_resize(const map_view_h view, int width, int height);
 ...
 * @see map_view_create()
 */
int map_view_set_visibility(const map_view_h view, bool visible);
 ...
 * @see map_view_create()
 */
int map_view_set_event_cb(const map_view_h view, map_event_type_e type,
 ...
 * @see map_view_create()
 */
int map_view_unset_event_cb(const map_view_h view, map_event_type_e type);
 ...
 * @see map_view_create()
 */
int map_view_set_gesture_enabled(const map_view_h view, map_gesture_e gesture, bool enabled);
 ...
 * @see map_view_create()
 */
int map_view_set_scalebar_enabled(const map_view_h view, bool enable);
 ...
 * @see map_view_create()
 */
int map_view_add_object(const map_view_h view, map_object_h object);
 ...
 * @see map_view_create()
 */
int map_view_remove_object(const map_view_h view, map_object_h object);

...
/**
 * @brief English as spoken in Great Britain.
 * @since_tizen 3.0
 */
#define MAP_VIEW_LANGUAGE_ENGLISH_GB "en-GB"

/**
 * @brief English as spoken in the USA.
 * @since_tizen 3.0
 */
#define MAP_VIEW_LANGUAGE_ENGLISH_US "en-US"

/**
 * @brief Russian as spoken in Russia.
 * @since_tizen 3.0
 */
#define MAP_VIEW_LANGUAGE_RUSSIAN "ru-RU"

/**
 * @brief German as spoken in Germany.
 * @since_tizen 3.0
 */
#define MAP_VIEW_LANGUAGE_GERMAN "de-DE"

/**
 * @brief French as spoken in France.
 * @since_tizen 3.0
 */
#define MAP_VIEW_LANGUAGE_FRENCH "fr-FR"

/**
 * @brief Spanish as spoken in Spain.
 * @since_tizen 3.0
 */
#define MAP_VIEW_LANGUAGE_SPANISH "es-ES"

/**
 * @brief Italian as spoken in Italy.
 * @since_tizen 3.0
 */
#define MAP_VIEW_LANGUAGE_ITALIAN "it-IT"

/**
 * @brief Simplified Chinese.
 * @since_tizen 3.0
 */
#define MAP_VIEW_LANGUAGE_CHINESE "zh-CN"

/**
 * @brief Hindi.
 * @since_tizen 3.0
 */
#define MAP_VIEW_LANGUAGE_HINDI "hi-in"

/**
 * @brief Korean.
 * @since_tizen 3.0
 */
#define MAP_VIEW_LANGUAGE_KOREAN "ko-kr"

/**
 * @brief Polish.
 * @since_tizen 3.0
 */
#define MAP_VIEW_LANGUAGE_POLISH "pl-pl"
 ...
 *  - #MAP_VIEW_LANGUAGE_ENGLISH_GB
 *  - #MAP_VIEW_LANGUAGE_ENGLISH_US
 *  - #MAP_VIEW_LANGUAGE_RUSSIAN
 *  - #MAP_VIEW_LANGUAGE_GERMAN
 *  - #MAP_VIEW_LANGUAGE_FRENCH
 *  - #MAP_VIEW_LANGUAGE_SPANISH
 *  - #MAP_VIEW_LANGUAGE_ITALIAN
 *  - #MAP_VIEW_LANGUAGE_CHINESE
 *  - #MAP_VIEW_LANGUAGE_HINDI
 *  - #MAP_VIEW_LANGUAGE_KOREAN
 *  - #MAP_VIEW_LANGUAGE_POLISH
 *  .
 *  \n If specific language wasn't set explicitly, the default language of your
 *  Maps Provider is used.
 *
 * @param[in]	view		The view handle
...
error = map_view_set_language(view, MAP_VIEW_LANGUAGE_RUSSIAN);
if(error != MAPS_ERROR_NONE) {
	// Handle the error
}
 * @endcode

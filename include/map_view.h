 ...
 */
typedef bool(*map_view_object_cb) (int index, int total,
 ...
 * @since_tizen 3.0
 * @remarks @a event_data must be released using map_view_event_data_destroy().
 * \n To use @a event_data outside this function, clone it with
 * map_view_event_data_clone().
 *
 ...
 * @since_tizen 3.0
 * @remarks To unregister the callback use this function with NULL @a callback
 * parameter
 *
 * @param[in]	view		The view handle
 * @param[in]	type		The new type of callback
 ...
 * previously with map_view_disable_gesture()
 *
 * @param[in]	view		The view handle
...
/**
 * @brief	Disables the user gesture.
 * @details This function blocks any reaction on a given user gesture.
 * @since_tizen 3.0
 *
 * @param[in]	view		The view handle
 * @param[in]	gesture		The user gesture
 ...
 * @see map_view_add_marker_image()
 */
int map_view_add_marker(map_view_h view,
			const maps_coordinates_h coordinates,
 ...
 * @details This function creates a visual object layer, representing the route,
 ...
 * @see #map_view_object_h
 */
int map_view_remove_object(map_view_h view, const map_view_object_h object);
 ...
 * @since_tizen 3.0
 * @remarks The objects will be delivered via map_view_object_cb().
 *
 * @param[in]	view		The view handle
 ...
 *
 * @post This function invokes map_view_object_cb() repeatedly to retrieve each
 * visual object.
 *
 * @see map_view_object_cb()
 */

 ...
 * Not all actions can be assigned with a specified gesture.
 * \n The table of gesture and action matching is following:
 ...
 * | #MAP_GESTURE_TAP                | #MAP_ACTION_SET_CENTER, \n #MAP_ACTION_ZOOM |
 * | #MAP_GESTURE_DOUBLE_TAP         | #MAP_ACTION_ZOOM, \n #MAP_ACTION_SET_CENTER |
 ...
 * | #MAP_GESTURE_PRESS              | #MAP_ACTION_SET_CENTER, \n #MAP_ACTION_ZOOM |
 * @remarks Note: all gestures can be matched with #MAP_ACTION_NONE. The
 * Application will keep recieving corresponding gesture notifications, however
 * the map view will not be changing.
 *
 * @since_tizen 3.0

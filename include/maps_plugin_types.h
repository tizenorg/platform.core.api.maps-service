...
#ifndef __MAPS_COORDINATES_PRIATE_H__
#define __MAPS_COORDINATES_PRIATE_H__
...
/* The definition of maps_coordinates_s have to be in *.cpp.*/
/**
...
#endif				/* __MAPS_COORDINATES_PRIVATE_H__ */

...
typedef enum _maps_service_e {
	...
	/** Indicates that maps_service_geocode_inside_area() service is
	 * allowed */
	MAPS_SERVICE_GEOCODE_INSIDE_AREA,

	/** Indicates that maps_service_geocode_by_structured_address()
	 * service is allowed */
	...
	/** Indicates that maps_service_search_place_by_area() service is
	 * allowed */
	MAPS_SERVICE_SEARCH_PLACE_BY_AREA,

	/** Indicates that maps_service_search_place_by_address() service is
	 * allowed */
	...
	/** Indicates that maps_service_search_route_waypoints() service is
	 * allowed */
	...
	/** Indicates that maps_service_multi_reverse_geocode() service is
	 * allowed
	 * (Since 3.0)*/
...
typedef enum _maps_service_data_e {
	...
	/** Indicates the availability of place category list in the Place
	 * data*/
	MAPS_PLACE_CATEGORIES,

	/** Indicates the availability of place attribute list in the Place
	 * data*/
	...
	/** Indicates the availability of place editorial list in the Place
	 * data*/
	...
	/** Indicates the availability of place supplier link value in the Place
	 * data*/
	MAPS_PLACE_SUPPLIER,
	...
	/** Indicates that the Route Data Structure is defined as a Path
	 * (a list of geographical coordinates) */
	MAPS_ROUTE_PATH,

	/** Indicates that the Route Data Structure is defined as a list of
	* Segments while each segment is defined as a Path*/
	MAPS_ROUTE_SEGMENTS_PATH,

	/** Indicates that the Route Data Structure is defined as a list of
	* Segments while each segment is defined as a list of Maneuvers*/
...
/**
 * @brief	Called when requested Multi Reverse Geocodes are responded by
 * the Maps Provider.
 * @since_tizen 3.0
 *
 * @param[in]	result			The result of request
 ...
 *
 * @param[in]	maps		The Maps Service handle
 * @param[in]	coordinates_list The coordinates list (a set of coordinates)
 * @param[in]	preference	The set of preferences for processing Reverse
 * Geocode

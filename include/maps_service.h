 ...
 * preferences are supported, see the lists of capacities and preferences above.
 * @deprecated Deprecated since 3.0 [Use maps_service_search_place_brief() instead]
 *
 * @param[in]	maps		The Maps Service handle
 ...
 * \n To check if Maps Provider is capable of Place Search and which Place
 * preferences are supported, see the lists of capacities and preferences above.
 * @deprecated Deprecated since 3.0 [Use maps_service_search_place_by_area_brief() instead]
 *
 * @param[in]	maps		The Maps Service handle
 ...
 * \n To check if Maps Provider is capable of Place Search and which Place
 * preferences are supported, see the lists of capacities and preferences above.
 * @deprecated Deprecated since 3.0 [Use maps_service_search_place_by_address_brief() instead]
 *
 * @param[in]	maps		The Maps Service handle

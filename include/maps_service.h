 ...
 * preferences are supported, see the lists of capacities and preferences above.
 * \n maps_service_search_place_brief() is effective to reduce network traffic.
 *
 * @param[in]	maps		The Maps Service handle
 ...
 * \n To check if Maps Provider is capable of Place Search and which Place
 * preferences are supported, see the lists of capacities and preferences above.
 * \n maps_service_search_place_by_area_brief() is effective to reduce network traffic.
 *
 * @param[in]	maps		The Maps Service handle
 ...
 * \n To check if Maps Provider is capable of Place Search and which Place
 * preferences are supported, see the lists of capacities and preferences above.
 * \n maps_service_search_place_by_address_brief() is effective to reduce network traffic.
 *
 * @param[in]	maps		The Maps Service handle

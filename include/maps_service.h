...
/**
 * @brief	Queries a basic place information by a coordinates position and a
 * distance. The request is asynchronous.
 * @details This function obtains the Place information for a specified distance
 * around a given coordinates position.
 * @since_tizen 3.0
 ...
 * information.
 *
 * @see maps_service_search_place_by_area_basic()
 * @see maps_service_search_place_by_address_basic()
 * @see maps_service_search_place_details()
 * @see maps_service_cancel_request()
 * @see maps_service_search_place_cb()
 */
int maps_service_search_place_basic(const maps_service_h maps,
			      const maps_coordinates_h position, int distance,
			      const maps_place_filter_h filter,
			      maps_preference_h preference,
			      maps_service_search_place_cb callback,
...
/**
 * @brief	Queries a basic place information by a coordinates boundary. The
 * request is asynchronous.
 * @details This function obtains the Place information for a specified
 * coordinates boundary.
 * @since_tizen 3.0
 ...
 * information.
 *
 * @see maps_service_search_place_basic()
 * @see maps_service_search_place_by_address_basic()
 * @see maps_service_search_place_details()
 * @see maps_service_cancel_request()
 * @see maps_service_search_place_cb()
 */
int maps_service_search_place_by_area_basic(const maps_service_h maps,
				      const maps_area_h boundary,
				      const maps_place_filter_h filter,
				      maps_preference_h preference,
				      maps_service_search_place_cb callback,
...
/**
 * @brief	Queries a basic place information by a free-formed address string.
 * The request is asynchronous.
 * @details This function obtains the Place information for a specified free-
 * formed address string.
 * @since_tizen 3.0
 ...
 * @see maps_service_search_place_cb()
 */
int maps_service_search_place_by_address_basic(const maps_service_h maps,
					 const char *address,
					 const maps_area_h boundary,
					 const maps_place_filter_h filter,
					 maps_preference_h preference,
 ...
 *  * maps_service_search_place_basic()
 *  * maps_service_search_place_by_area_basic()
 *  * maps_service_search_place_by_address_basic()
 * @post It invokes maps_service_search_place_cb() to deliver obtained Place
 * information.
 *
 * @see maps_service_search_place_basic()

 ...
 */
typedef void(*maps_place_details_cb) (maps_error_e error,
 ...
 * @post It invokes maps_place_details_cb() to deliver obtained Place information.
 *
 * @see maps_service_search_place_around()
 * @see maps_place_details_cb()
 * @see maps_service_cancel_request()
 * @see maps_service_provider_is_service_supported()
 */
int maps_service_search_place_details(const maps_service_h maps,
			      const char *uri, maps_place_details_cb callback,
			      void *user_data, int *request_id);

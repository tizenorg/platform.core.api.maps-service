...
typedef enum _maps_service_e {
	...
	MAPS_SERVICE_MULTI_REVERSE_GEOCODE	/**  Indicates that
			maps_service_multi_reverse_geocode() service is allowed */
} maps_service_e;
...
/**
 * @brief	Called when requesting multi reverse geocoding to Maps Provider Server is responsed.
 * @since_tizen 3.0
 *
 * @param[in]	result			The result of request
 * @param[in]	request_id		The id of request
 ...
 * @param[in]	user_data		The user data passed from maps_service_multi_reverse_geocode()
 *
...
/**
 * @brief	Gets the address list for a given position coordinates list. The request
 * is asynchronous.

...
#ifndef __MAP_VIEW_EVENT_DATA_H__
#define __MAP_VIEW_EVENT_DATA_H__

/**
 *
 * @ingroup	CAPI_MAP_VIEW_MODULE
 * @defgroup	CAPI_MAP_VIEW_EVENT_MODULE Map View Event Data
 *
 * @file map_view_event_data.h
 * @brief This file contains the functions related to Maps View Event Data
 * information.
 *
 * @addtogroup CAPI_MAP_VIEW_EVENT_MODULE
 * @{
 ...
 * @remarks To release the handle use map_view_event_data_destroy().
 * \n To clone the handle use map_view_event_data_clone().
 * @since_tizen 3.0
 *
 * @see map_view_event_data_destroy()
 * @see map_view_event_data_clone()
 */
typedef void *map_view_event_data_h;
 ...
 * @since_tizen 3.0
 */
typedef enum _map_view_gesture_e {
 ...
 * @since_tizen 3.0
 */
typedef enum _map_view_action_e {
 ...
 * @see map_view_event_data_clone()
 */
int map_view_event_data_destroy(map_view_event_data_h event);
 ...
 */
int map_view_event_data_clone(const map_view_event_data_h origin,
 ...
 * in #map_view_event_type_e
 * @return	0, otherwise a negative error value
 * @retval	#MAPS_ERROR_NONE Successful
 * @retval	#MAPS_ERROR_INVALID_PARAMETER Invalid parameter
 *
 * @see #map_view_event_type_e
 */
int map_view_event_data_get_type(const map_view_event_data_h event,
 ...
 * #MAP_VIEW_EVENT_GESTURE or returns the #MAPS_ERROR_NOT_SUPPORTED instead
 * @since_tizen 3.0
 *
 * @param[in]	event		The event data handle
 * @param[out]	gesture_type	The type of the gesture, one of values,
 * enumerated in #map_view_gesture_e
 * @return	0, otherwise a negative error value
 * @retval	#MAPS_ERROR_NONE Successful
 * @retval	#MAPS_ERROR_INVALID_PARAMETER Invalid parameter
 ...
 * supported
 *
 * @see #map_view_gesture_e
 */
int map_view_event_data_get_gesture_type(map_view_event_data_h event,
 ...
 * #MAP_VIEW_EVENT_ACTION or returns the #MAPS_ERROR_NOT_SUPPORTED instead
 * @since_tizen 3.0
 *
 * @param[in]	event		The event data handle
 * @param[out]	action_type		The type of the action, one of values,
 * enumerated in #map_view_action_e
 * @return	0, otherwise a negative error value
 * @retval	#MAPS_ERROR_NONE Successful
 * @retval	#MAPS_ERROR_INVALID_PARAMETER Invalid parameter
 ...
 * supported
 *
 * @see #map_view_action_e
 */
int map_view_event_data_get_action_type(map_view_event_data_h event,
 ...
 * is #MAP_VIEW_EVENT_ACTION or returns the #MAPS_ERROR_NOT_SUPPORTED instead
 * @since_tizen 3.0
 *
 * @param[in]	event		The event data handle
 ...
 */
int map_view_event_data_get_center(map_view_event_data_h event,
 ...
 * movement if the event type is #MAP_VIEW_EVENT_ACTION or returns the
 ...
 * @retval	#MAPS_ERROR_NOT_SUPPORTED The @a x and @a y values is not supported
 */
int map_view_event_data_get_delta(map_view_event_data_h event,
 ...
 * supported
 */
int map_view_event_data_get_xy(map_view_event_data_h event, int *x, int* y);
 ...
 * when the event type is #MAP_VIEW_EVENT_GESTURE or returns the
 * #MAPS_ERROR_NOT_SUPPORTED instead
 * @since_tizen 3.0
 *
 * @param[in]	event		The event data handle
 ...
 */
int map_view_event_data_get_fingers(map_view_event_data_h event, int *fingers);

/**
 * @brief	Gets zoom factor of zoom gesture or action.
 * @details When the event type is #MAP_VIEW_EVENT_GESTURE or
 * #MAP_VIEW_EVENT_ACTION this function gets the corresponding zoom factor.
 ...
 * supported
 */
int map_view_event_data_get_zoom_factor(map_view_event_data_h event,
					double *zoom_factor);

/**
 * @brief	Gets rotation angle of rotation gesture or action.
 * @details When the event type is #MAP_VIEW_EVENT_GESTURE or
 * #MAP_VIEW_EVENT_ACTION this function gets the corresponding rotation angle.
 * Otherwise it returns #MAPS_ERROR_NOT_SUPPORTED.
 * @since_tizen 3.0
 *
 * @param[in]	event		The event data handle
 ...
 * supported
 */
int map_view_event_data_get_rotation_angle(map_view_event_data_h event,
					   double *rotation_angle);

/**
 * @brief	Gets tilt of action.
 * @details When the event type is  #MAP_VIEW_EVENT_ACTION this function gets
 ...
 */
int map_view_event_data_get_tilt(map_view_event_data_h event, double *tilt);

/**
 * @brief	Gets object of event.
 * @details When the event type is  #MAP_VIEW_EVENT_OBJECT this function gets
 ...
 */
int map_view_event_data_get_object(map_view_event_data_h event,
 ...
 * @}
 */
#endif				/* __MAP_VIEW_EVENT_DATA_H__*/

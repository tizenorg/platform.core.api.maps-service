 ...
 */
int map_object_set_visible(const map_object_h object, bool visible);
 ...
 * @see map_object_create_polyline()
 */
int map_object_polyline_set_width(const map_object_h polyline, int width);
 ...
 */
int map_object_marker_resize(const map_object_h marker, int width, int height);
 ...
 */
int map_object_marker_set_z_order(const map_object_h marker, int z_order);

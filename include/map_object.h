...
typedef enum _map_object_type_e {
	...
	MAP_OBJECT_UNKNOWN,		/** Indicates the unknown type of visual object */
} map_object_type_e;
...
int map_object_create_marker(const maps_coordinates_h coordinates,
	const char *image_file_path, const map_marker_type_e type, map_object_h *marker);
...
int map_object_create_polyline(const maps_coordinates_list_h coordinates,
	...
	const unsigned char a, const int width, map_object_h *polyline);
 ...
 * @see map_object_create_polyline()
 */
int map_object_destroy(const map_object_h object);
 ...
 * @details This function moves the object on the map to specified geographical coordinates.
 * @since_tizen 3.0
 *
 * @param[in]	object		The object handle
 ...
 */
int map_object_move(const map_object_h object, const maps_coordinates_h coordinates);
 ...
 * @see maps_coordinates_create()
 */
int map_object_marker_set_coordinates(const map_object_h marker, const maps_coordinates_h coordinates);
 ...
 */
int map_object_marker_resize(const map_object_h marker, const int width, const int height);
 ...
 * @see map_object_create_marker()
 */
int map_object_marker_set_image_file(const map_object_h marker, const char *file_path);

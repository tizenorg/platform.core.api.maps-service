 ...
 * @param[in]	total		The total amount of points, comprisint the
 * polyline
 ...
 * @see map_object_group_remove_object()
 */
int map_object_group_add_object(map_object_h group, const map_object_h object);
 ...
 * @details This function adds a goegraphical coordinates point to the
 * specified polygon.
 * @since_tizen 3.0
 *

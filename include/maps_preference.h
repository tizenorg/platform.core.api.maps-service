 ...
 * @retval	#MAPS_ERROR_INVALID_PARAMETER Invalid parameter
 */
int maps_preference_get_route_alternatives(const maps_preference_h preference, bool *enable);
 ...
 *
 * @see maps_preference_create()
 * @see maps_preference_get_route_alternatives()
 */
int maps_preference_set_route_alternatives(maps_preference_h preference, bool enable);

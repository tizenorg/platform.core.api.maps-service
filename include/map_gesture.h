 ...
 * @defgroup	CAPI_MAP_EVENT_MODULE Map View Gestures
 *
 * @file map_gesture.h
 ...
 * map_view_set_gesture_callback() and map_view_unset_gesture_callback()
 * respectively.
 */
...
/**
 * @brief	Clones the gesture data handle.
 * @details This function clones the gesture data handle @a origin and all its
 * resources.
 * @since_tizen 3.0
 * @remarks @a cloned must be released using map_gesture_destroy().
 *
 * @param[in]	origin		The original gesture data handle
 * @param[out]	cloned		A cloned gesture data handle
 * @return	0 on success, otherwise a negative error value
 * @retval	#MAPS_ERROR_NONE Successful
 * @retval	#MAPS_ERROR_OUT_OF_MEMORY Out of memory
 * @retval	#MAPS_ERROR_INVALID_PARAMETER Invalid parameter
 *
 * @pre @a origin may be obtained in map_view_on_gesture_cb()
 *
 * @see #map_gesture_h
 * @see map_gesture_destroy()
 * @see map_view_on_gesture_cb()
 */
int map_gesture_clone(const map_gesture_h origin, map_gesture_h *cloned);

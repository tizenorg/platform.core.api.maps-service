...
/*  temporal features */
#define IMPROVEMENT_OF_GESTURES_AND_ACTIONS
#define IMPROVEMENT_OF_VISUAL_OBJECTS
...
typedef enum _map_gesture_e {
	MAP_GESTURE_SCROLL = 1, /** Indicates the pan user gesture */
	...
	*/	
	...
	MAP_CONTROL_FLICK, /**< Indicates the tap user gesture */

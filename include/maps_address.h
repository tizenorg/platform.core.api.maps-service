 ...
 */
typedef bool (*maps_address_list_cb)(int index, maps_address_h address, void *user_data);
 ...
 */
int maps_address_list_foreach(maps_address_list_h address_list, maps_address_list_cb callback, void *user_data);

 ...
 * @details The address handle can be obtained via call of maps_address_create()
 * @since_tizen 2.4
 */
 ...
 * @details The coorindates list handle can be obtained via calling of maps_address_list_create().
 * @since_tizen 3.0
 */
typedef maps_list_h maps_address_list_h;
...
/**
 * @brief	Creates a batch geocoder address list.
 * @since_tizen 3.0
 *
 ...
 *
 * @param[in]	address_list	The address list handle
 * @param[in]	length	The number of elements in the address list
 * @return	0 on success, otherwise a negative error value
 * @retval	#MAPS_ERROR_NONE Successful
 * @retval	#MAPS_ERROR_NOT_SUPPORTED Not supported
 * @retval	#MAPS_ERROR_INVALID_PARAMETER Invalid parameter
 ...
 * @see maps_address_list_destroy()
 */
int maps_address_list_length(maps_address_list_h address_list, int *length);
 ...
 */
typedef bool (*address_cb)(int index, maps_address_h address, void *user_data);
 ...
 * @param[in]	country	The country name
 * @param[in]	county	The county name
 * @param[in]	state	The state name
 * @param[in]	city	The city name
 * @param[in]	district	The district name
 * @param[in]	street	The street name
 * @param[in]	building_number	The building number or house number
 * @param[in]	freetext	The text describing address
 * @param[in]	user_data	The user data passed from the foreach function
 *
 * @return @c true to continue with the next iteration of the loop, \n
 *         @c false to break out of the loop
 * @see maps_address_list_foreach_address()
 *
typedef bool (*address_cb)(int index, const char *country_code, const char *country, const char *county, const char *state,
			const char *city, const char *district, const char *street, const char *building_number, const char *freetext, void *user_data);
 */


/**
 * @brief Retrieves all addresses by invoking a specific callback for each address of batch geocoder.
 * @since_tizen 3.0
 *
 * @param[in]	address_list	The address list handle
 ...
 * @see maps_address_list_create()
 * @see maps_address_list_destroy()
 * @see maps_address_list_length()
 */
int maps_address_list_foreach_address(maps_address_list_h address_list, address_cb callback, void *user_data);

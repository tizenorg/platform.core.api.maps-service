...
/**
 * @brief	Indicate whether the map should show the 3D buildings layer.
...
/**
 * @brief	Query whether the map has the 3D buildings layer enabled.
...
/**
 * @brief	Indicate whether the map should show the traffic layer.
...
/**
 * @brief	Query whether the map has the traffic layer enabled.
...
/**
 * @brief	Indicate whether the map should show the public transit layer.
...
/**
 * @brief	Query whether the map has the public transit layer enabled.

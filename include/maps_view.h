 ...
 * @see maps_view_create()
 */
int maps_view_set_event_cb(maps_view_h view, maps_event_type_e type,
 ...
 * @see maps_view_create()
 */
int maps_view_unset_event_cb(maps_view_h view, maps_event_type_e type);
 ...
 * @see maps_view_create()
 */
int maps_view_set_gesture_enabled(maps_view_h view, maps_gesture_e gesture, bool enabled);
 ...
 * @see maps_view_create()
 */
int maps_view_get_gesture_enabled(const maps_view_h view, maps_gesture_e gesture, bool *enabled);
 ...
 *
 * @pre @a view is created using maps_view_create().
 * @pre @a object is created using #maps_object_create_marker(),
 * maps_object_create_polygon(), maps_object_create_polyline() or
 * maps_object_create_group()
 *
 * @see #maps_object_h
 * @see maps_object_create_marker()
 * @see maps_object_create_polygon()
 * @see maps_object_create_polyline()
 * @see maps_view_remove_object()
 * @see maps_view_remove_all_objects()
 * @see maps_view_create()
 */
int maps_view_add_object(maps_view_h view, maps_object_h object);
 ...
 * @see maps_view_create()
 */
int maps_view_remove_object(maps_view_h view, maps_object_h object);
 ...
 * @since_tizen 3.0
 * @remarks The objects will be delivered via maps_object_cb().
 *
 * @param[in]	view		The view handle
 ...
 * @pre @a view is created using maps_view_create().
 * @pre objects are added using maps_view_add_object().
 * @post This function invokes maps_object_cb() repeatedly to retrieve each
 * visual object.
 *
 * @see #maps_object_h
 * @see maps_object_cb()
 ...
 * @see maps_view_create()
 */
int maps_view_foreach_object(const maps_view_h view, maps_object_cb callback, void *user_data);
